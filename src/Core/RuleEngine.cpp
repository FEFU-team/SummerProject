...
std::vector<CaptureMove> RuleEngine::check_capture(const std::pair<int, int>& coordinate_start, const  std::vector<std::vector<int>>& int_grid, bool queen_take)
{
	std::vector<CaptureMove> coordinate;
