...
TextButton::TextButton(sf::Vector2f position, sf::String text,  sf::Vector2f size, sf::Color button_color, sf::Color text_color, unsigned int text_size, sf::Font font):Button(position, size, button_color)
{
